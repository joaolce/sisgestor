...
JanelasComuns = {
	...
	showInformation: function(mensagem){
		...
		var img = Builder.node("img", {src: this.imagemInformacao, width:16, height: 16});
		var divImg = Builder.node("div", {style: "float: left; margin-right: 10px; margin-left: 3px;"}, [img]);
		var divMsg = Builder.node("div", {style: "padding-top: 4px; margin-left: 30px;"});
		divMsg.innerHTML = mensagem;
		Element.setStyle(divMsg, {
			fontWeight: "bold",
			color: "#007AE2"
		});
		var primeiro = Builder.node("div", [
			divImg,
			divMsg 
		]);
		var segundo = Builder.node("div", {align: "center", style: "clear: both; padding-top: 10px;"}, [
			Builder.node("input", {type: "button", CLASS: "botaoOkCancelar", value: "OK", id: "confirmarBotao"})
		]);
	...
	showConfirmDialog: function(mensagem, funcTrue, funcFalse){
		...
		var img = Builder.node("img", {src: this.imagemConfirmacao, width:22, height: 22});
		var divImg = Builder.node("div", {style: "float: left; margin-right: 10px; margin-left: 3px;"}, [img]);
		var divMsg = Builder.node("div", {style: "padding-top: 4px; margin-left: 30px;"}, [document.createTextNode(mensagem)]);
		Element.setStyle(divMsg, {
			fontWeight: "bold",
			color: "#007AE2"
		});
		...
		var segundo = Builder.node("div", {align: "center", style: "clear: both; padding-top: 10px;"}, [
			Builder.node("input", {type: "button", CLASS: "botaoOkCancelar", value: "OK", id: "confirmarBotao"}),
			Builder.node("input", {type: "button", CLASS: "botaoOkCancelar", value: "Cancelar", id:"cancelarBotao"})
		]);
	...
	carregarNovaPagina: function(){
		...
		janela.adicionarConteudo(document.createTextNode("Aguarde enquanto uma nova página é carregada..."));
	...
	sessaoFinalizada: function (){
		JanelasComuns.showConfirmDialog("A sessão atual foi finalizada, deseja ir para página de login?", function(){
...
/**
 * cria uma janela dentro da tela atual de acordo com as especificações passadas
 * e carrega a url passada dentro dela
 * 
