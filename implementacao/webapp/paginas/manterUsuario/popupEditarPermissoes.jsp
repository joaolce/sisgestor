...
<html:form action="/manterUsuario.do?method=atualizarPermissoes" onsubmit="usuario.atualizarPermissoes(this); JanelaFactory.fecharJanelaAtiva(); return false;" styleId="manterUsuarioForm">
	...
	<div style="clear: both; padding: 5px;" align="center">	
		<html:submit titleKey="dica.ok" styleClass="botaoOkCancelar">
