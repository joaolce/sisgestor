...
<html:form action="/manterProcesso.do?method=salvar" onsubmit="processo.salvar(this); return false;" styleId="manterProcessoForm">
	<fieldset style="margin: 5pt auto; padding: 10px;">
		<html:hidden property="workflow" styleId="workflowNovoProcesso" />
		<label style="float: left; margin-top: 15px;">
			...
			<br />
			<html:text property="nome" styleId="nomeNovoProcesso" size="51" maxlength="100" />
		</label> 
		<label style="float: left; margin-top: 15px;">
			<b>
			...
			<br />
			<html:textarea property="descricao" styleId="descricaoNovoProcesso" rows="4" cols="50" onkeypress="processo.contaChar(true);" onkeydown="processo.contaChar(true);" onkeyup="processo.contaChar(true);" />
			<br />
			<bean:message key="label.maximoCaracteres" arg0="200"/>:
			<span id="contagemNovoProcesso" style="color: red;"></span>
		</label>
	</fieldset>
