...
<div style="width: 100%; background-color:#003366;">
	...
	<div class="cab" style="width: 31%; height: 35px; margin-left: auto;" >
		<logic:present name="usuarioSessao">
			<div title="<bean:write name="usuarioSessao" property="nome"/>" style="width: 60%; height: 16px; overflow: hidden; float: left;">
