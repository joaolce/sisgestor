...
@AttributeOverrides( {
		...
		@AttributeOverride(name = "nome", column = @Column(name = "WOR_NOME", nullable = false, length = ConstantesBanco.NOME)),
		@AttributeOverride(name = "descricao", column = @Column(name = "WOR_DESCRICAO", nullable = true, length = ConstantesBanco.DESCRICAO))})
