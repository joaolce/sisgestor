...
@AttributeOverrides( {
		...
		@AttributeOverride(name = "nome", column = @Column(name = "ATI_NOME", nullable = false, length = ConstantesBanco.NOME)),
		@AttributeOverride(name = "descricao", column = @Column(name = "ATI_DESCRICAO", nullable = true, length = ConstantesBanco.DESCRICAO))})
