...
<div class="bordas" id="BordaExterna" style="height: 486px;">
		...
		<html:form action="/manterAtividade.do" onsubmit="atividade.pesquisar(); return false;" styleId="manterAtividadeForm">
			<div style="float: left;">
				...
				<label style="float: left; margin-left: 20px;">
					...
					<br />
					<html:select property="departamentoResponsavel" styleId="departamentoPesquisa">
	...
	<html:form action="/manterAtividade.do?method=atualizar" onsubmit="atividade.atualizar(this); return false;" styleId="formSalvar" style="display: none; margin-top: 10px;">
