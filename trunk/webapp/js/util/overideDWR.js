 ...
 * 
 * Sobrescreví o comportamento desse método para que ele continue se comportando 
 * como estava nas versões 1.x.x . 
 * 
 ...
 * 	</code>
 * 
 * Com a implementação anterior era possível setar um valor boleano para indicar
 * se um checkbox está marcado ou não o que foi utilizado no sistema inteiro:
 * 
 * <code>
 ...
 * </code>
 * 
 * Agora na versão 2.x.x esse comportamento não acontece mais, o setValue só marca o checkbox
 * se o valor que foi passado é igual ao valor do checkbox
 * 
